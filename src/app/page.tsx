      ...
      <section className="bg-white py-24 border-t border-gray-200">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            {/* Track 3 Link */}
            <Link href="/future" className="group bg-[#EAECEF] border border-gray-300 p-8 shadow-sm rounded-sm hover:shadow-md transition-shadow flex flex-col items-start h-full">
              <div className="flex justify-between w-full items-start mb-6">
                <div className="bg-gray-400 text-white text-[10px] font-bold px-2 py-1 uppercase tracking-widest rounded-sm">Track 3</div>
                <div className="w-10 h-10 border border-gray-300 bg-white rounded-sm flex items-center justify-center group-hover:bg-gray-50 transition-colors">
                  <Workflow className="text-gray-500 group-hover:text-gray-800" size={20} />
                </div>
              </div>
              <h3 className="text-2xl font-bold mb-3 text-gray-800 group-hover:text-blue-700 transition-colors font-serif">未來：載入中</h3>
              <p className="text-gray-500 font-medium leading-relaxed mb-8 flex-grow">
                客觀的系統癱瘓數據。<br/>透視五人極限運作的系統瓶頸，與身分連動。
              </p>
              <span className="text-sm font-bold text-gray-500 flex items-center gap-1 group-hover:text-blue-600 mt-auto">
                開始探索 <ArrowRight size={14} />
              </span>
            </Link>
