...
export const FACTORS: readonly FactorNote[] = [
  {
    id: 'f1-1958-drop',
    claim:
      '1957 年 9 件，1958 年 2 件。1958-07-21 公布的司法院大法官會議法第 13 條第 1 項把解釋憲法的通過條件定為總額四分之三出席、出席人四分之三同意。',
    basis: 'statute',
    basisRef: '司法院大法官會議法第 13 條第 1 項（1958-07-21 公布）',
    uncertainty:
      '落差發生在換法同年，但本圖無法區分「通過條件造成通不過」與「聲請量本身減少」。不受理與聲請件數不在 813 筆內。',
    needsRuling: 'legal-reviewer',
  },
  {
    id: 'f2-ramp-precedes',
    claim:
      '案件量的回升自 1986 年起（1986 年 11 件、1988 年 13 件、1989 年 16 件、1990 年 22 件、1992 年 22 件、1993 年 21 件），全部早於 1993-02-03 的法規變動。1987 年為 9 件，低於 1986 年。',
    basis: 'data',
    basisRef: '813 筆釋字發布日期的逐年彙總（tests/fixtures/interpretation-dates.json）',
    uncertainty:
      '回升早於法規變動這件事本圖可證，造成回升的原因本圖不能證。會議記錄說 1987 年那次修法把表決條件改低、並因此造成案件暴增；實際的修法公布日是 1993-02-03，且案件量自 1986 年起已在回升，會議的時間順序不成立。須確認會議原意是否指其他事件。',
    needsRuling: 'captain',
  },
  {
    id: 'f3-1994-peak',
    claim: '1994 年 37 件，為全期最高，出現在通過條件放寬後第二年。',
    basis: 'data',
    basisRef: '813 筆釋字發布日期的逐年彙總（tests/fixtures/interpretation-dates.json）',
    uncertainty:
