...
export const TIMELINE_EVENTS: TimelineEvent[] = [
  ...
  },
  {
    ...
    detail: '立法院三讀通過《憲法訴訟法》修正案，將憲法法庭作成判決的門檻大幅提高為「現有大法官總額中至少10人參與評議、至少9人同意」。這個修法表面上是「提高司法品質」，實際上搭配立法院當時已凍結大法官人事同意權（不審查新提名人），等於讓憲法法庭無法達到開庭門檻。',
    category: 'legislative',
    significance: 'high',
    actors: ['立法院', '國民黨', '民眾黨'],
  ...
  },
  {
    ...
    detail: '2024年10月31日，蔡英文總統時期提名的七位大法官任期屆滿正式離任，憲法法庭僅剩八位大法官。而同年12月20日三讀通過的《憲法訴訟法》修正案要求至少10人參與評議，八位大法官根本無法達到門檻，憲法法庭在新法2025年1月23日生效後面臨實質停擺。',
  ...
  },
  {
    ...
    detail: '賴清德總統依憲法規定提名新任大法官人選送交立法院行使同意權。2024年12月24日，第一次提名遭國民黨與民眾黨控制的立法院投票否決。2025年7月25日，第二次提名再度遭否決。立法院透過否決提名人選，使憲法法庭無法補足大法官人數。搭配修法墊高的門檻，憲法法庭自2025年1月23日新法生效起無法正常運作，直到同年12月19日該門檻失效。',
    category: 'political',
    significance: 'high',
    actors: ['賴清德', '立法院', '國民黨', '民眾黨'],
    consequence: '在修法墊高的門檻存續期間（2025年1月23日至12月19日），憲法法庭無法達到開庭門檻，違憲審查機能癱瘓。',
  },
  {
    id: 'evt-12',
    date: '2025-01-23',
  ...
  },
  {
    ...
    detail: '隨著時間推移，更多大法官因任期屆滿而離任。由於立法院當時不行使同意權，新提名人選未能上任。2025年中，憲法法庭因人數不足無法達到新修《憲法訴訟法》的開庭門檻，數百件待審案件累積未決，人民的釋憲聲請無法獲得及時處理。這凸顯了制度僵局對人民權利的實質傷害。',
    category: 'constitutional',
    significance: 'medium',
    actors: ['憲法法庭', '立法院'],
  ...
  },
  {
    ...
    detail: `憲法法庭就《憲法訴訟法》修正案本案作成判決（114年憲判字第1號），僅5位大法官參與，3位大法官（蔡宗珍、楊惠欽、朱富美）拒絕參與。判決宣告立法院以修法墊高門檻、搭配否決人事來癱瘓憲法法庭的做法違憲。${VOIDED_FLOOR_SHORT}。判決指出：違憲審查是憲法的核心制度保障，立法權不得以任何方式實質廢除之。這是台灣憲政史上的里程碑判決，確立了「立法多數的權力界限」這一關鍵原則。張娟芬的評析文章即針對此判決而寫。`,
    category: 'resolution',
    significance: 'high',
    actors: ['憲法法庭'],
